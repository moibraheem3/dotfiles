// base on: https://github.com/ryzendew/Reborn-Quickshell/blob/main/.config/quickshell/Widgets/CustomTrayMenu.qml
...
PopupWindow {
    ...
    implicitWidth: 280
    implicitHeight: Math.max(40, listView.contentHeight + 10)
    visible: false
    color: "transparent"
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            height: (modelData?.isSeparator) ? 0 : 32
            color: "transparent"
            radius: 8
